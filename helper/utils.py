...
def joint_angle_plotting(update, folder_name, t_range, CPG_signal, \
                         ...
                         FR_calf_joint_history, FL_calf_joint_history, RR_calf_joint_history, RL_calf_joint_history, type='CPG'):
...
def CPG_and_velocity_plotting(update, folder_name, n_steps, CPG_signal_period_traj, target_velocity_traj, real_velocity_traj, type='CPG'):
...
def exp_contact_plotting(update, folder_name, contact_log):

    np.savez_compressed(f'{folder_name}/contact_{update}.npz', contact=contact_log)
...
def exp_CPG_and_velocity_plotting(update, folder_name, n_steps, CPG_signal_period_traj, target_velocity_traj, real_velocity_traj):
