...
for update in range(iteration_number, 10000):
    ...
    if update % cfg['environment']['eval_every_n'] == 0:
        ...
        CPG_and_velocity_plotting(update, saver.plot_dir, evaluate_n_steps, None, target_velocity_traj, real_velocity_traj, type='baseline')
    ...
    if update % 50 == 0:
        joint_angle_plotting(update, saver.plot_dir, np.arange(n_steps) * cfg['environment']['control_dt'], None,\
                                ...
                                FR_calf_joint_history, FL_calf_joint_history, RR_calf_joint_history, RL_calf_joint_history, type='baseline')
