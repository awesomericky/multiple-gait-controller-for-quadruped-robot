            ...
            if (numContact_ > 0)
            {
                for (int k = 0; k < numContact_; k++)
                {
                    if (!anymal_->getContacts()[k].skip())
                    {
                        ...
                        if (idx == 2 && footPos_W[0][2] < 0.03 && !footContactState_[0])
                        {
                        ...
                        else if (idx == 4 && footPos_W[1][2] < 0.03 && !footContactState_[1])
                        {
                        ...
                        else if (idx == 6 && footPos_W[2][2] < 0.03 && !footContactState_[2])
                        {
                        ...
                        else if (idx == 8 && footPos_W[3][2] < 0.03 && !footContactState_[3])
                        {
