...
class ENVIRONMENT : public RaisimGymEnv {
 ...
 public:
  ...
  explicit ENVIRONMENT(const std::string& resourceDir, const Yaml::Node& cfg, bool visualizable) :
    ...
    /// get robot data
    gcDim_ = anymal_->getGeneralizedCoordinateDim();  // 19 (w/o fixing any joints)
    gvDim_ = anymal_->getDOF();  // 18 (w/o fixing any joints)
    nJoints_ = gvDim_ - 6;  // 12 (w/o fixing any joints)
