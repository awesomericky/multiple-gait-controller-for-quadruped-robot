...
if weight_path == "":
    ...
    for step in range(max_steps):
        ...
        action_history.append(action_ll.cpu().detach().numpy())
    ...
    np.savez_compressed('obs_history', obs=obs_history)
    np.savez_compressed('action_history', action=action_history)
